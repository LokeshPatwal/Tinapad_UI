            ...
            <Box sx={{ py: '2%', px: '5%', display: 'flex', flexDirection: 'column', rowGap: '2rem' }}>
                ...
                <Box sx={{ textAlign: 'left', px: '5%' }}>
                    <Box sx={{ mb: '4%' }}>
                        ...
                        <Paragraph sx={{ fontWeight: '400', fontSize: '20px', lineHeight: '30px', opacity: '0.56', my: '1rem' }}>GemPad is a frontline protocol for users and project-owners to launch their projects and tokens.
                        </Paragraph>
                    </Box>
                    <Box sx={{ display: 'flex', flexDirection: 'column', rowGap: '2rem' }}>
                        ...
                        <Image sx={{ width: { xs: '95%', sm: '30%' } }} disabledEffect visibleByDefault
